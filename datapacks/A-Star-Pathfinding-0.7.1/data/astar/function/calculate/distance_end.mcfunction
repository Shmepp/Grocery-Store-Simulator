data modify storage astar:math xyz set from entity @s Pos
execute store result score x astar.h run data get storage astar:math xyz[0]
execute store result score y astar.h run data get storage astar:math xyz[1]
execute store result score z astar.h run data get storage astar:math xyz[2]
