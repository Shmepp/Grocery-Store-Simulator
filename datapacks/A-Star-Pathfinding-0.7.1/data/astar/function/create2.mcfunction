...
# Check if End — if true, mark as finalizer and skip the calculations
execute align xyz if entity @n[dx=0,dy=0,dz=0,type=marker,predicate=astar:is_end] run return run function astar:mark_finalizer
