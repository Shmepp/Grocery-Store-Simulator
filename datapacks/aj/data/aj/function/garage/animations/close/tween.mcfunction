...
function aj:garage/animations/pause_all
tag @s add aj.garage.animation.close.playing
...
execute at @s run function aj:garage/animations/close/zzz/apply_frame {frame: 0}
$execute at @s run function aj:garage/animations/close/zzz/apply_frame {frame: $(to_frame)}
