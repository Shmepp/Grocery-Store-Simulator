...
tag @s add aj.garage.animation.open.playing
...
execute at @s run function aj:garage/animations/open/zzz/apply_frame {frame: 0}
$execute at @s run function aj:garage/animations/open/zzz/apply_frame {frame: $(to_frame)}
