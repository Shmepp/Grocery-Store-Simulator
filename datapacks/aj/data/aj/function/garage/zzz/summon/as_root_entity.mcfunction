...
data modify storage animated_java:temp entry.data.blueprint_id set value "aj:garage"
data modify storage animated_java:temp entry.data.rig_hash set value "747802330d836293cb550442535ef8d0f1f87cdf485174e5eec955755356d690"
tp @s ~ ~ ~ ~ ~
execute on passengers if entity @s[tag=aj.garage.node.door] run function aj:garage/zzz/summon/as_node/door
data modify storage animated_java:temp entry.data.uuids append from storage animated_java:gu out
...
function aj:garage/zzz/set_default_pose
execute if data storage animated_java:temp args.variant run function aj:garage/zzz/summon/zzz/variant_arg/no_variants_warning
execute if score #success aj.i matches 0 run return fail
execute if data storage animated_java:temp args.animation run function aj:garage/zzz/summon/animation_arg/process with storage animated_java:temp args
execute if score #success aj.i matches 0 run return fail
