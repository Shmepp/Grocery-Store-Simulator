...
tag @s add aj.front_door.animation.open.playing
...
execute at @s run function aj:front_door/animations/open/zzz/apply_frame {frame: 0}
$execute at @s run function aj:front_door/animations/open/zzz/apply_frame {frame: $(to_frame)}
